...
public class ImGuiHelper : IDisposable
{
    ...
    /// <summary>
    /// Constructs a new ImGuiHelper.
    /// </summary>
    public ImGuiHelper(GraphicsDevice gd, OutputDescription outputDescription, int width, int height)
    {
        _gd = gd;
        _windowWidth = width;
    ...
    {
        Assembly assembly = typeof(ImGuiHelper).Assembly;
